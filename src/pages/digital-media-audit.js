...
/* TO DO - IMPLEMENT THESE AS gatsby-image */
...
const AuditDigitalMedia = () => {
  return (
    <div id="digital-media-audit">
      <Layout>
        <AuditHeroSection 
          heading="Digital Media Audit"
          subheading="Our digital media audit is a holistic examination of your brands digital media effectiveness"
